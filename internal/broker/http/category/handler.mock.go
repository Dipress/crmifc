...
func (m *MockService) Create(ctx context.Context, f *category.Form) (*category.Category, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Find(ctx context.Context, id int) (*category.Category, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Update(ctx context.Context, id int, f *category.Form) (*category.Category, error) {
	m.ctrl.T.Helper()
