...
func (m *MockService) Create(ctx context.Context, f *role.Form) (*role.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Find(ctx context.Context, id int) (*role.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Update(ctx context.Context, id int, f *role.Form) (*role.Role, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) List(ctx context.Context) (*role.Roles, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List", ctx)
	ret0, _ := ret[0].(*role.Roles)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
