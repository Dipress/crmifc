...
func (m *MockService) Create(ctx context.Context, f *user.Form, u *user.User) error {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) Create(ctx, f, u interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockService)(nil).Create), ctx, f, u)
}

// Find mocks base method
func (m *MockService) Find(ctx context.Context, id int) (*user.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Update(ctx context.Context, id int, f *user.Form) (*user.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) List(ctx context.Context) (*user.Users, error) {
	m.ctrl.T.Helper()
